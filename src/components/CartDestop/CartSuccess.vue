...
export default defineComponent({
  setup() {
    ...
    const isDisable = computed(() => {
      if (orderExperience.value.rate === "" || note.value.trim() === "") {
        return true;
      }
    ...
    const setReport = (rate) => {
      store.commit("setOrderExperience", {
        rate,
        note: note.value,
      });
    };
        ...
        <div class="order-success__body">
          ...
          <div class="border border-C0 px-12 py-20 rounded-3 ls-20">
            ...
            <div class="row gx-3 mb-12">
              ...
              <div class="col-8 fw-semi">{{ money(subPrice) }}</div>
            </div>
            <div class="row gx-3 mb-12">
              ...
              <label class="custom-checkbox" @click="() => setReport('Tạm ổn')">
                <span class="checkmark-experience">
                  <svg
                    class="checkmark-experience__icon"
                    :fill="
                      orderExperience.rate === 'Tạm ổn' ? '#004377' : '#cacbd2'
                    "
                    xmlns="http://www.w3.org/2000/svg"
                    width="48.937"
                    height="48.937"
              ...
              >
                <span class="checkmark-experience">
                  <svg
                    class="checkmark-experience__icon"
                    :fill="
                      orderExperience.rate === 'Tuyệt vời'
                        ? '#004377'
                        : '#cacbd2'
                    "
                    xmlns="http://www.w3.org/2000/svg"
